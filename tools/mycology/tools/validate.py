...
report=[];passed=0
if node:
 for command in [[node,'--test','tests/core.test.mjs'],[node,'--experimental-loader','./tests/mock-loader.mjs','--test','tests/adapters.test.mjs'],[node,'--experimental-loader','./tests/mock-loader.mjs','--test','tests/field-guide.test.mjs'],[node,'--experimental-loader','./tests/mock-loader.mjs','--test','tests/ui.test.mjs'],[node,'--experimental-loader','./tests/mock-loader.mjs','--test','tests/reveal.test.mjs']]:
...
lines=['# 検証レポート','',f'実行日：2026-09-20。**自動テスト {passed}件 合格。Bedrock実機テストは未実施。**','',f'内部整合チェック：{len(checks)}アサーション合格。これは公式スキーマの全検証件数ではありません。','',
