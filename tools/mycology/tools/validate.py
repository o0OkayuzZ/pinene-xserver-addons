...
report=[];passed=0
if node:
 for command in [[node,'--test','tests/core.test.mjs'],[node,'--experimental-loader','./tests/mock-loader.mjs','--test','tests/adapters.test.mjs'],[node,'--experimental-loader','./tests/mock-loader.mjs','--test','tests/field-guide.test.mjs'],[node,'--experimental-loader','./tests/mock-loader.mjs','--test','tests/ui.test.mjs'],[node,'--experimental-loader','./tests/mock-loader.mjs','--test','tests/reveal.test.mjs'],[node,'--test','tests/nf-state.test.mjs'],[node,'--experimental-loader','./tests/mock-loader.mjs','--test','tests/nf-runtime.test.mjs']]:
