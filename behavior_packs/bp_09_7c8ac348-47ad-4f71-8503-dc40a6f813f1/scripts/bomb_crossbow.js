...
const EXPLOSION_PROFILES = Object.freeze({
  ...
  "pinene:sniper_tnt_crossbow": { depth: 0, radius: 4 },
  "pinene:sniper_tnt_crossbow_awakened_1": { depth: 1, radius: 5 },
  "pinene:sniper_tnt_crossbow_awakened_2": { depth: 2, radius: 6 },
  "pinene:sniper_tnt_crossbow_awakened_3": { depth: 3, radius: 7 }
});
...
// The depth is captured when the projectile is spawned. Sniper TNT variants use
// the same bomb bolt and therefore share this exact explosion contract.
...
console.info("[BombCrossbow] v0.3 shared TNT / sniper-TNT explosion runtime loaded");
